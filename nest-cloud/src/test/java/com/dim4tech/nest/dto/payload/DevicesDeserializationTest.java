...
public class DevicesDeserializationTest {
    ...
    public void deserializationTest() throws Exception {
        Devices result = deserializationService.deserialize(json, Devices.class);
        assertEquals(ExpectedObjectsBuilder.buildExpectedDevices(), result);
    }
}
