...
public class SmokeCoAlarmsLoaderTest {
    ...
    private final SmokeCoAlarmsLoader loader;
    ...
    public void load() throws Exception {
        try {
            startSimpleServer();
            Map<DeviceId, SmokeCoAlarm> expected = new HashMap<>();
            SmokeCoAlarm smokeCoAlarm = ExpectedObjectsBuilder.buildExpectedSmokeCoAlarm();
            expected.put(smokeCoAlarm.getDeviceId(), smokeCoAlarm);
    ...
    private void startSimpleServer() {
        try {
            ...
            httpServer.createContext("/devices/smoke_co_alarms", httpExchange -> {
